...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="quienes-somos.php">Quienes somos</a></li>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
        <h1>Quienes Somos</h1>
        <p>Tenemos una gran trayectoria como uno de los mejores cines del pais.</p>
       </div>
      ...
      <div id="about-us">
        <h3>Un poco de historia</h3>
          ...
          <p>Vestibulum pharetra gravida ipsum, ut ultrices neque elementum sit amet. Maecenas mollis tincidunt ipsum, sollicitudin ultricies erat laoreet ut. Donec eget neque consectetur, egestas felis in, porta tellus. Morbi a nibh nibh. Quisque vel dolor non elit facilisis malesuada. Sed vulputate justo ut nunc laoreet, a volutpat eros sodales. Donec libero justo, varius a facilisis non, lobortis sed sem. Vestibulum auctor neque elit, nec lobortis mi ullamcorper nec. Vivamus mattis porta sem, quis vulputate est aliquet et. Nulla eu neque non tellus placerat varius. </p>
      </div>
